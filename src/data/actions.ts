...
export const actions: ActionItem[] = [
  {
    ...
    context: 'Floor vote scheduled June 10. Submission deadline May 30.',
    ownerId: 'noah-stein',
    dueDate: '2026-05-30',
    priority: 'urgent',
    status: 'in_progress',
    ...
    entity: { type: 'policy', id: 'nyc-food-expansion', label: 'NYC Food Expansion Act', link: '/policy/nyc-food-expansion' },
  ...
  },
  {
    ...
    context: 'Application window closes May 15. Up to $250K available for direct food assistance services.',
    ownerId: 'tessa-moore',
    dueDate: '2026-05-15',
    priority: 'high',
    status: 'open',
    ...
    entity: { type: 'policy', id: 'anti-eviction-funding', label: 'City Emergency Food Aid Funding', link: '/policy/anti-eviction-funding' },
  ...
  },
  {
    ...
    title: 'Audit reporting workflow for food assistance change',
    ...
    entity: { type: 'policy', id: 'rental-assistance-reporting', label: 'Federal Food Assistance Reporting Change', link: '/policy/rental-assistance-reporting' },
  ...
  },
  {
    ...
    context: 'Major donor highly engaged on food access. Good moment to share Food Expansion Act progress.',
    ownerId: 'leah-kim',
    dueDate: '2026-04-16',
    priority: 'medium',
    status: 'open',
  ...
  },
  {
    ...
    title: 'Extract messaging from Bronx Food Collective emergency aid campaign',
    ...
    cta: 'Open campaign',
    entity: { type: 'peer', id: 'bronx-housing', label: 'Bronx Food Collective', link: '/peers/bronx-housing' },
  ...
  },
  {
    ...
    title: 'Brief residents on emergency food aid window opening',
    context: 'City emergency food funding opens April 9. Coordinate flyer and outreach in Brooklyn and Queens program sites.',
    ownerId: 'tessa-moore',
    dueDate: '2026-04-17',
    priority: 'high',
    status: 'in_progress',
  ...
  },
  {
    ...
    context: 'State community food bank tax credit revision in proposed status. Board wants a position by next meeting.',
    ...
    entity: { type: 'policy', id: 'housing-tax-credit', label: 'State Community Food Bank Tax Credit Revision', link: '/policy/housing-tax-credit' },
    visibleTo: ['executive', 'policy'],
    createdBy: 'noah-stein',
